...
class ApiController extends Controller
{
    ...
    public function register(Request $request) {
        return response()->json(['message' => 'Lo lagi ngapain anjir awakwoakwoakkk'], 201);
    }
            ...
            if($request->input('authToken')){
                ...
                if ($siswa) {
                    if ($siswa->username == $siswaName) {
                        $cek = $siswa->kehadiran->where('tanggal', $currentDate);
                        if ($cek->count() > 0) {
                            return response()->json(['status' => 'error', 'message' => "Not Allowed, This Student ($siswa->nama) Already Absent"], 403);
                        } else {
                            ...
                            if ($act) {
                                ...
                                return response()->json(['status' => 'ok', 'message' => "absent $siswa->nama created By Tutor $tutor"], 201);
                            } else {
                ...
                return response()->json(['status' => 'error', 'message' => 'Lo ngapain anjir awowkoakwakk'], 404);
            }
