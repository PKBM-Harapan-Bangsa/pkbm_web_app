...
<div class="mb-5 flex items-center">
  ...
  <div id="date-range-picker" date-rangepicker class="flex items-center">
    <div class="relative">
      ...
      <input value="{{ isset($start) ? $start : '' }}" id="datepicker-range-start" name="start" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date start">
    </div>
    ...
    <div class="relative">
      ...
      <input value="{{ isset($end) ? $end : '' }}" id="datepicker-range-end" name="end" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date end">
  </div>
  </div>

  <div class="ml-5">
    <button class="px-4 py-2.5 bg-white rounded hover:bg-gray-100">Filter</button>
  </div>

  @if(isset($start))
  <div class="ml-5">
    Data diFilter dari <span class="font-bold underline">{{ $start }}</span> hingga <span class="font-bold underline">{{ $end }}</span>
  </div>
  @endif
