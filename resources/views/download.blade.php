...
<div class="flex items-center justify-between">
    ...
    <a id="downloadButton" href="{{ url('/download/PKBMharbang-V2') }}" class="text-white text-center bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm pr-5 pl-3 py-2.5 inline-flex items-center me-2">
