...
<meta property="og:image:secure_url" content="https://pkbmharbang.com/img/logo.png">
<meta property="og:image:url" content="https://pkbmharbang.com/img/logo.png">
<meta property="og:locale" content="id_ID">    
<meta property="og:title" content="PKBM Harapan Bangsa">
<meta property="og:description" content="Aplikasi Terintegrasi PKBM Harapan Bangsa, Pantau Absensi Siswa Anda di Website Resmi PKBM Harapan Bangsa">
...
<script type="application/ld+json">
{
  ...
  "url": "https://pkbmharbang.com",
  "logo": "https://pkbmharbang.com/img/logo.png",
  "description": "PKBM Harapan Bangsa, Pusat Kegiatan Belajar Masyarakat Kabupaten Banyumas, Jawa Tengah, Pendidikan Non-formal, Kejar Paket A, Kejar Paket B, Kejar Paket C"
}
</script>
    ...
    <meta name="description" content="PKBM Harapan Bangsa adalah lembaga pendidikan non-formal yang menyediakan berbagai program pendidikan untuk semua usia. Temukan kursus-kursus berkualitas dan fasilitas yang memadai untuk menunjang pembelajaran Anda.">
    <meta name="keywords" content="PKBM Harapan Bangsa, lembaga pendidikan non-formal, kursus pendidikan, belajar online, pelatihan kerja">
...
<body>
    ...
    <nav class=" border-gray-200 dark:bg-gray-900 dark:border-gray-700 sticky w-full top-0 bg-white/75 z-50">
        ...
        <a href="{{ url('/') }}" class="flex items-center">
            <img src="/img/logo.png" class="h-8 mr-3" alt="Logo PKBM Harapan Bangsa" />
            <h1 class="self-center text-lg sm:text-2xl font-semibold whitespace-nowrap ">PKBM Harapan Bangsa</h1>
        </a>
    ...
    <main>
        <section class="h-[35vh] sm:h-[50vh] bg-cover bg-no-repeat bg-center shadow-xl" style="background-image: url('/img/banner_1.jpg');"></section>
        ...
        <section class="flex items-center justify-center sm:flex-row flex-col sm:px-20 px-6 bg-gradient-to-b from-orange-100 to-white pt-20 sm:pt-10 -mt-24 -z-10">
            ...
            <div class="flex-1 order-2 sm:order-1 px-0 sm:px-14 sm:text-md mt-0 text-md">
                ...
                <h1 class="text-justify indent-5 mb-2">
                ...
                <h2 class="text-justify indent-5 mb-2">
                ...
                <h3 class="text-justify indent-5 mb-3">
            ...
            <div class="w-full max-w-sm flex flex-col items-center justify-center order-1 sm:order-2 py-2 relative">
                ...
                <img src="/img/profile_1.png" class="px-5 w-2/3 sm:w-full z-20" alt="ketua-pkbm-harbang">
